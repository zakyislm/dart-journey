...
1. Pembuatan Software cross platform
   Dart digunakan sebagai bahasa pemrograman di Flutter untuk membuat aplikasi yang dapat dijalankan dari berbagai platform hanya dengan satu kali pengerjaan.
2. Ekspansi ke Software Desktop & Web
   Google telah melakukan ekspansi dengan memperbarui kemampuan Flutter untuk membuat aplikasi web yang modern dan Desktop Software (*Windows*,*macOS*, dan *Linux*)
3. Back-End Development Support
   Dart juga memiliki beberapa framework yang mendukung Back-End Development, seperti *Dart Frog* atau *Shelf* dan juga mendukung pembuatan API menggunakan bahasa yang sama persis untuk membuat UI interface.
